package karelle.env.royal.utils;
...
import karelle.env.royal.utils.FirebaseArray;
...
public abstract class FirebaseRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public void onBindViewHolder(VH viewHolder, int position) {
        ...
        String fireKey = mSnapshots.getItem(position).getKey();

        try {
            Field key = viewHolder.getClass().getDeclaredField("key");
            key.set(viewHolder, fireKey);
